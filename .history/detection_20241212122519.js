...
function calculateDayOfYear() {
  ...
  const dayOfYear = Math.floor(diff / oneDay) + 1; // Calculate the day number, add 1 to start from Day 1
...
// Get the current year and set the total days
const today = new Date();
const totalDays = isLeapYear(today.getFullYear()) ? 366 : 365;

// Update the content of the header with the current day and total days
