...
function onResults(results) {
  ...
  canvasElement.width = window.innerWidth*.9;  // Set internal width based on window size
  canvasElement.height = window.innerHeight*.9;  // Set internal height based on window size
