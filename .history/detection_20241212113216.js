...
function checkDistances(landmarks) {
  ...
  if (distThumbIndex > 100 || distThumbMiddle < 100 || distThumbRing < 100 || distThumbPinky < 100) {
    console.log('Changing background color to green!');
    canvasElement.style.backgroundColor = '000000'; // Change background color to green
  } else {
