  ...
  if (results.multiHandLandmarks) {
    for (const landmarks of results.multiHandLandmarks) {
      // Extract landmarks using the defined constants
         ...
         // Position the div at the wrist's location
         const wristDiv = document.getElementById('wrist-div');
         wristDiv.style.left = `${wristX}px`;
         wristDiv.style.top = `${wristY}px`;
   
         // Optionally, draw the landmarks on the canvas (if desired)
      ...
      // console.log('Middle Tip:', middleTip);
      // console.log('Ring Tip:', ringTip);
      // console.log('Little Tip:', littleTip);
