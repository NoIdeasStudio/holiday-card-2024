...
function onResults(results) {
  ...
  if (results.multiHandLandmarks) {
    ...
    results.multiHandLandmarks.forEach((landmarks, handIndex) => {
      ...
      const index = landmarks[1]; // Wrist is at index 0 in the landmarks array
      const indexDivId = `wrist-div-${handIndex}`;
      positionLandmarkDiv(wrist, indexDivId, `wrist-${handIndex}`, "f");
