...
document.addEventListener("DOMContentLoaded", function() {
  ...
  // Define the path using a `path()` function
  movingDiv.style.offsetPath = "path('M50,300 Q150,50 300,150 T550,300')";

  // Optionally, set the starting position of the moving div
  movingDiv.style.offsetDistance = "0%";
});
